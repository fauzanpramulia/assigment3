...
var PORT = ":8088"
var POSTURL = "http://localhost" + PORT + "/update/" + ID_ENVIRONTMENT
var METHOD = "POST"
...
// func DetermineStatus(ctx echo.Context) error {
// 	db := database.GetDB()
...
// 	env.Water 	= float64(rand.Intn(100) + 1)
// 	env.Wind	=  float64(rand.Intn(100) + 1)
